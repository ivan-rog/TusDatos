...
class TusDatosWebClientTest {
    ...
    void setUp() throws IOException {
        ...
        ReflectionTestUtils.setField(this.tusDatosWebClient, "endpointReportJson", "/api/report_json/{id}");
    }
    ...
    private MockResponse mockReportJson() {
        return new MockResponse()
                .setResponseCode(200)
                .addHeader("Content-Type", "application/json").setBody(this.reportJsonBody());
    }

    private String reportJsonBody() {
        return "{\n" +
                "    \"cidob\": {\n" +
                "        \"Alias\": \" \",\n" +
